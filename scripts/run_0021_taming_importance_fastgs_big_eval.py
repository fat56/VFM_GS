...
DEFAULT_CONFIG = "configs/experiments/0021_taming_importance_fastgs_big_full9.yaml"
DEFAULT_BASELINE = "output/0002/phase0_5090_fastgs_big_baseline_fix1/mipnerf360_combined/summary.csv"
DEFAULT_METHOD = "taming_importance_fastgs_prune_densify100"
DEFAULT_RUN_NAME = "taming_importance_fastgs_prune_30k_r_auto"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run 0021 Taming-importance FastGS big ablation.")
...
def main() -> int:
    ...
    for scene in args.scenes:
        ...
        print("[0021] {} taming-importance FastGS big train/render/metrics".format(scene), flush=True)
