...
- full-scene 缓存优先从 `dinov2_vits14` 或 `dinov2_vitb14`、`max_width` 518-640 开始。`max_width` 224 配合 `--limit` 继续作为快速验证目标。
...
- 快速验证结果：PSNR 20.2913，SSIM 0.4272，LPIPS 0.6006，77,761 个 Gaussians，训练时间 1.72s。
